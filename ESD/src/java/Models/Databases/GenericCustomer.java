 ...
 * @author t2-sheedy
 */
public class GenericCustomer extends DatabaseTables {
    ...
    public GenericCustomer(int id) {
        this.ID = id;
        //GetDetail();
    }

    public GenericCustomer(String name, String address, int id) {
        this.Name = name;
...
//    public GenericCustomer GetDetails() {
//
//        Connection con;
//        Statement state;
//        ResultSet rs;
...
//
//                if (rowCount == 1) {
//                    return new GenericCustomer(nam, add, id);
//                } else {
